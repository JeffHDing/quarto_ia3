...
We present the standard deviations in @tbl-horse-sd-table.
...
Additionally, note that in @tbl-horse-sd-table we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-canada.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse-pop-with-sd width=50%}

In @fig-horse-pop-with-sd we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
